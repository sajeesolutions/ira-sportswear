          ...
          <div className="relative isolate overflow-hidden bg-gray-900 px-2 pt-16 shadow-2xl sm:rounded-3xl sm:px-16 md:pt-24 lg:flex lg:gap-x-20 lg:px-24 lg:pt-0">
            ...
            <div className="mx-auto max-w-md text-center lg:mx-0 lg:flex-auto lg:py-32 lg:text-left">
              <h2 className="text-balance text-3xl font-semibold tracking-tight text-white sm:text-4xl">
                Our Latest News and Clients Videos.
              </h2>
              <p className="mt-6 text-pretty text-lg/8 text-gray-300">
                Join us on a journey of innovation and excellence. Explore our latest news and client videos to stay updated on the latest trends, achievements, and collaborations.
              </p>
              <div className="mt-10 flex items-center justify-center gap-x-6 lg:justify-start">
                ...
                <a href="#" className="text-sm/6 font-semibold text-white">
                  Blog More <span aria-hidden="true">→</span>
                </a>
              </div>
            </div>
